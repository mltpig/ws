...
class CollectGoods extends BaseController
{
    ...
    public function index()
    {
        ...
        $result = PlayerActorService::getInstance()->send($actorId,'paradiseCollectSelfGoods', $this->param );

        if(is_array($result)) TaskService::getInstance()->setVal($this->player,67,1,'add');
