...
\EasySwoole\Command\CommandManager::getInstance()->addCommand(new \App\Command\Actor());

defined('NOTIFY_URL') or define('NOTIFY_URL','https://ysjdftz.shenzhenyuren.com/wx');

defined("CHANNEL") or define("CHANNEL", "wydzg_yfb" );
...
defined('_SELF') or define('_SELF','self');
defined('VISITOR') or define('VISITOR','visitor');
